...
<section id="news">
    <div class="inn">
        <article>
            ...
            <p>The winner to the long awaited screenshot labor day contest is <em>hukt0nf0nikz</em>. Congratulations! Your screenshot is now featured in the sidebar. All screenshots from the contest can be found in the <a href="gallery">gallery</a>.</p></p>                    
            <p>The <a href="maps">maps</a> page has also been updated with new images. You can thank CrewmanInRed for most of them.</p>
        </article>
        <article>
        ...
        <article>
            ...
            <p>The winner for the very first Screenshot Saturday is Sanchezenia! Your screenshot will be featured in the sidebar for the next couple weeks.  All of the screenshots can be viewed in the <a href="gallery">gallery</a>.</p>
        </article>
        <article>
            <h1>New Website</h1>
            <p class="date">8/7/2013</p>
            ...
            <p>Image gallery can be found <a href="gallery">here</a>.</p>
...
<script type="text/javascript" src="<?php echo base_url(); ?>asset/js/application/pages/home.js"></script>